...
class OutroLeft: UIViewController, UINavigationControllerDelegate, UIImagePickerControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        print("OutroLeft loaded")
        self.scroll.contentSize = self.scroll.superview!.bounds.size
        ...
        OutroLeft.player = AVQueuePlayer(items: items)
        OutroLeft.avpController = AVPlayerViewController()
        OutroLeft.avpController.player = OutroLeft.player
        ...
        OutroLeft.player2 = AVQueuePlayer(items: items2)
        OutroLeft.avpController2 = AVPlayerViewController()
        OutroLeft.avpController2.player = OutroLeft.player2
    ...
    @IBAction func playEvent(_ sender: Any) {
        ...
        self.present(OutroLeft.avpController, animated: true){
            OutroLeft.avpController.player?.play()
        }
    }
    
    @IBAction func playEvent2(_ sender: Any) {
        //thumbnailView.image = AVAsset(url: URL(string: hifiEventArray.last!)!).videoThumbnail!
        self.present(OutroLeft.avpController2, animated: true){
            OutroLeft.avpController2.player?.play()
        }
    }
    ...
    @IBAction func pressedDiscard(_ sender: Any) {
        ...
        self.present(alert, animated: true) {
            alert.addAction(UIAlertAction(title: "Continue", style: UIAlertActionStyle.destructive, handler: { action in
                ...
                // do something like...
                self.performSegue(withIdentifier: "exitOutroLeft", sender: nil)
    ...
    func imagePickerController(_ picker: UIImagePickerController, didFinishPickingMediaWithInfo info: [String : Any]) {
        ...
        if let pickedVideo:URL = (info[UIImagePickerControllerMediaURL] as? URL) {
            ...
            if (imagePicker.sourceType == .camera){
                let selectorToCall = #selector(OutroLeft.videoWasSavedSuccessfully(_:didFinishSavingWithError:context:))
