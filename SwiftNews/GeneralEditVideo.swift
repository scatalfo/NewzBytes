//
//  GeneralEditVideo.swift
//  SwiftNews
//
//  Created by Benjamin Catalfo on 11/18/17.
...
class GeneralEditVideo: UIViewController, ABVideoRangeSliderDelegate {
    ...
    override func viewDidLoad() {
        ...
        let playerItem = AVPlayerItem(url: URL(string: commentaryArray[commentaryIndexPathItem])!)
        ...
        rangeSlider.setVideoURL(videoURL: URL(string: commentaryArray[commentaryIndexPathItem])!)
    ...
    @IBAction func pressedDone(_ sender: Any) {
        avPlayer.pause()
        cropVideo(sourceURL1: URL(string: commentaryArray[commentaryIndexPathItem])!, statTime: Float(startTime), endTime: Float(endTime))
        performSegue(withIdentifier: "generalEditDone", sender: nil)
    }
    func cropVideo(sourceURL1: URL, statTime:Float, endTime:Float){
        ...
        exportSession.exportAsynchronously{
            ...
            case .completed:
                ...
                commentaryArray[commentaryIndexPathItem] = outputURL.absoluteString
            case .failed:
