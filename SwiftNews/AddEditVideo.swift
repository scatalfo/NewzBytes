...
//  SwiftNews
//
//  Created by Benjamin Catalfo on 10/15/17.
...
class AddEditVideo: UIViewController, ABVideoRangeSliderDelegate {
    ...
    override func viewDidLoad() {
        ...
        let playerItem = AVPlayerItem(url: URL(string: tempArray.last!)!)
        ...
        rangeSlider.setVideoURL(videoURL: URL(string: tempArray.last!)!)
    ...
    @IBAction func pressedDone(_ sender: Any) {
        avPlayer.pause()
        cropVideo(sourceURL1: URL(string: tempArray.last!)!, statTime: Float(startTime), endTime: Float(endTime))
        tempArray.removeAll()
        performSegue(withIdentifier: "exitAddEdit", sender: nil)
    }
