...
//  SwiftNews
//
//  Created by Benjamin Catalfo on 10/6/17.
...
var commentaryArray = [String]()

class Commentary: UIViewController, UINavigationControllerDelegate, UIImagePickerControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        Commentary.player = AVQueuePlayer(items: items)
        Commentary.avpController = AVPlayerViewController()
        Commentary.avpController.player = Commentary.player
    ...
    static func updatePlayer(){
        ...
        Commentary.player = AVQueuePlayer(items: items)
        Commentary.avpController.player = self.player
 ...
 */
    ...
    @IBAction func playEvent(_ sender: Any) {
        ...
        self.present(Commentary.avpController, animated: true){
            Commentary.avpController.player?.play()
        }
    }
    ...
    @IBAction func pressedDiscard(_ sender: Any) {
        ...
        self.present(alert, animated: true) {
            alert.addAction(UIAlertAction(title: "Continue", style: UIAlertActionStyle.destructive, handler: { action in
                ...
                // do something like...
                self.performSegue(withIdentifier: "exitCommentary", sender: nil)
    ...
    func imagePickerController(_ picker: UIImagePickerController, didFinishPickingMediaWithInfo info: [String : Any]) {
        ...
        if let pickedVideo:URL = (info[UIImagePickerControllerMediaURL] as? URL) {
            ...
            if (imagePicker.sourceType == .camera){
                let selectorToCall = #selector(Commentary.videoWasSavedSuccessfully(_:didFinishSavingWithError:context:))
        ...
        imagePicker.dismiss(animated: true, completion: {
             ...
             */
            commentaryArray.append(self.nextElement)
            self.performSegue(withIdentifier: "toOutro", sender: nil)
        })
    }
