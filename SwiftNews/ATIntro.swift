...
class ATIntro: UIViewController, UINavigationControllerDelegate, UIImagePickerControllerDelegate{
    ...
    func imagePickerController(_ picker: UIImagePickerController, didFinishPickingMediaWithInfo info: [String : Any]) {
        ...
        if let pickedVideo:URL = (info[UIImagePickerControllerMediaURL] as? URL) {
            ...
            if (imagePicker.sourceType == .camera){
                let selectorToCall = #selector(ATIntro.videoWasSavedSuccessfully(_:didFinishSavingWithError:context:))
        ...
        imagePicker.dismiss(animated: true, completion: {
            ...
            hifiEventArray.append(self.nextElement)
            //self.postAlert("test",message: "video saved in photo library and added to article sucessfully")
            //}
            self.performSegue(withIdentifier: "ATIntroFinished", sender: nil)
        })
    }
