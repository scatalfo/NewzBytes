...
class CaptureEvent: UIViewController, UINavigationControllerDelegate, UIImagePickerControllerDelegate{
    ...
    func imagePickerController(_ picker: UIImagePickerController, didFinishPickingMediaWithInfo info: [String : Any]) {
        ...
        if let pickedVideo:URL = (info[UIImagePickerControllerMediaURL] as? URL) {
            ...
            let selectorToCall = #selector(CaptureEvent.videoWasSavedSuccessfully(_:didFinishSavingWithError:context:))
        ...
        imagePicker.dismiss(animated: true, completion: {
            ...
            //if (self.imagePicker.sourceType == .photoLibrary){
                eventArray.append(self.nextElement)
