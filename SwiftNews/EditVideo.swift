...
//  SwiftNews
//
//  Created by Benjamin Catalfo on 10/7/17.
...
class EditVideo: UIViewController, ABVideoRangeSliderDelegate {
    ...
    override func viewDidLoad() {
        ...
        let playerItem = AVPlayerItem(url: URL(string: hifiEventArray.last!)!)
        ...
        rangeSlider.setVideoURL(videoURL: URL(string: hifiEventArray.last!)!)
    ...
    @IBAction func pressedDone(_ sender: Any) {
        avPlayer.pause()
        cropVideo(sourceURL1: URL(string: hifiEventArray.last!)!, statTime: Float(startTime), endTime: Float(endTime))
        performSegue(withIdentifier: "editToCommentary", sender: nil)
    }
        ...
        exportSession.exportAsynchronously{
                ...
                case .completed:
                   ...
                   hifiEventArray.popLast()
                    hifiEventArray.append(outputURL.absoluteString)
