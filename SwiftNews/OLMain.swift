...
class OLMain: UIViewController, UINavigationControllerDelegate, UIImagePickerControllerDelegate{
    ...
    func imagePickerController(_ picker: UIImagePickerController, didFinishPickingMediaWithInfo info: [String : Any]) {
        ...
        if let pickedVideo:URL = (info[UIImagePickerControllerMediaURL] as? URL) {
            ...
            if (imagePicker.sourceType == .camera){
                let selectorToCall = #selector(OLMain.videoWasSavedSuccessfully(_:didFinishSavingWithError:context:))
        ...
        imagePicker.dismiss(animated: true, completion: {
            ...
            //}
            self.performSegue(withIdentifier: "OLMainFinished", sender: nil)
        })
    }
