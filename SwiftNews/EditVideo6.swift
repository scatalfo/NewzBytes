...
class EditVideo6: UIViewController, ABVideoRangeSliderDelegate {
    ...
    override func viewDidLoad() {
        ...
        let playerItem = AVPlayerItem(url: URL(string: outroArray.last!)!)
        ...
        rangeSlider.setVideoURL(videoURL: URL(string: outroArray.last!)!)
    ...
    @IBAction func pressedDone(_ sender: Any) {
        avPlayer.pause()
        cropVideo(sourceURL1: URL(string: outroArray.last!)!, statTime: Float(startTime), endTime: Float(endTime))
        performSegue(withIdentifier: "editToAllThree3", sender: nil)
    }
    func cropVideo(sourceURL1: URL, statTime:Float, endTime:Float){
        ...
        exportSession.exportAsynchronously{
            ...
            case .completed:
                ...
                outroArray.popLast()
                outroArray.append(outputURL.absoluteString)
