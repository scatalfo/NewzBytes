...
var hifiEventArray: [String] = [String]()

class View4: UIViewController, UINavigationControllerDelegate, UIImagePickerControllerDelegate{
    ...
    func imagePickerController(_ picker: UIImagePickerController, didFinishPickingMediaWithInfo info: [String : Any]) {
        ...
        imagePicker.dismiss(animated: true, completion: {
            ...
            //}
            self.performSegue(withIdentifier: "getEvent", sender: nil)
        })
    }
