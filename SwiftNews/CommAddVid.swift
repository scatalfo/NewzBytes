...
//  SwiftNews
//
//  Created by Benjamin Catalfo on 10/14/17.
...
class CommAddVid: UIViewController, UINavigationControllerDelegate, UIImagePickerControllerDelegate{
    ...
    func imagePickerController(_ picker: UIImagePickerController, didFinishPickingMediaWithInfo info: [String : Any]) {
        ...
        if let pickedVideo:URL = (info[UIImagePickerControllerMediaURL] as? URL) {
            ...
            let selectorToCall = #selector(View4.videoWasSavedSuccessfully(_:didFinishSavingWithError:context:))
        ...
        imagePicker.dismiss(animated: true, completion: {
            ...
            tempArray.append(self.nextElement)
            //self.postAlert("test",message: "video saved in photo library and added to article sucessfully")
            //}
            self.performSegue(withIdentifier: "addCommToEdit", sender: nil)
        })
    }
